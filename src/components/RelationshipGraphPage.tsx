...
import { ArrowLeft, ExternalLink, Users, Link2, Brain } from 'lucide-react';
      ...
      <div className="mb-6">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbPage className="text-white">Relationship Graph View</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl">Relationship Graph View</h1>
